...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            <h3 class="text-lg font-semibold text-gray-800">Form Input Data Produk</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description"
                              ...
                              class="w-full px-4 py-2 border @error('description') border-red-300 bg-red-50 @else border-gray-300 @enderror rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600 font-medium">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center">
                        ...
                        <label for="is_active" class="ml-2 block text-sm font-medium text-gray-900 cursor-pointer">
                            Publikasikan & Aktifkan Produk ini segera
                        </label>
                    </div>
                    @error('is_active')
                        <p class="mt-1 text-sm text-red-600 font-medium">{{ $message }}</p>
