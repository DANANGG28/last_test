...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200/80 p-5">
        <div class="flex items-center">
            <div class="flex-shrink-0 bg-emerald-50 text-emerald-600 rounded-lg p-3">
                <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM3 19.235v-.11a6.375 6.375 0 0 1 12.75 0v.109A12.318 12.318 0 0 1 9.374 21c-2.331 0-4.512-.645-6.374-1.766Z" />
                </svg>
            </div>
            <div class="ml-4">
                <p class="text-xs font-medium uppercase tracking-wider text-slate-500">Daftar Hari Ini</p>
                <p class="text-2xl font-bold text-slate-900 mt-0.5">{{ $todayUsers }}</p>
            </div>
        </div>
    </div>

    {{-- Card: Total Produk --}}
    <a href="{{ route('products.index') }}" class="bg-white rounded-xl shadow-sm border border-slate-200/80 p-5 hover:border-blue-300 hover:shadow-md transition group">
        <div class="flex items-center">
            <div class="flex-shrink-0 bg-blue-50 group-hover:bg-blue-600 rounded-lg p-3 transition text-blue-600 group-hover:text-white">
                <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                </svg>
            </div>
            <div class="ml-4">
                <p class="text-xs font-medium uppercase tracking-wider text-slate-500 group-hover:text-blue-600 transition">Total Produk</p>
                <p class="text-2xl font-bold text-slate-900 mt-0.5">{{ $totalProducts }}</p>
            </div>
        </div>
    </a>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200/80 p-5">
        <div class="flex items-center">
            <div class="flex-shrink-0 bg-slate-100 text-slate-600 rounded-lg p-3">
                <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <div class="ml-4">
                <p class="text-xs font-medium uppercase tracking-wider text-slate-500">App Environment</p>
                <p class="text-2xl font-bold text-slate-900 mt-0.5">{{ ucfirst(app()->environment()) }}</p>
            </div>
        </div>
    </div>
</div>
